...
OBJS = main.o FAssetManager.o FPhysicsEngine.o FTick.o FPlayerController.o UObject.o FActor.o FPawn.o FController.o STransform.o FFPSMeter.o FChrono.o FEngine.o FWindow.o FInputManager.o FEngineLoop.o FSimpleRenderer.o FShaderManager.o
...
FAssetManager.o:
	g++ $(CFLAGS) -c ./Engine/Renderer/AssetManager/FAssetManager.cpp
